export const projects_en = [
  ...
  // Portuguese translation of the projects
export const projects_pt = [
      {
        title: 'CineView 2.0 Movie App',
        description:
          'Aplicativo de filmes que permite aos usuários buscar seus filmes favoritos, ver os filmes em alta, populares e mais bem avaliados. Também permite assistir trailers e vídeos de filmes específicos. Hospedado no Vercel.',
        image: './assets/cineview2.png',
        technologies: ['ReactJS', 'Tailwind CSS', 'Sass', 'TMDB API', 'ViteJS', 'React-Router', 'React-Icons', 'React-Paginate', 'React-Player'],
        buttons: [
          { text: 'Ver Código Fonte', link: 'https://github.com/eburzlaff/cine-view-2.0-movie-app' },
          { text: 'Demo ao Vivo', link: 'https://cine-view-2-0-movie-app.vercel.app/' }
        ],
        id: 0
      },
      {
        title: 'Real Estate App',
        description:
          'Aplicativo imobiliário que permite aos usuários se registrarem, fazer login, logout, visualizar perfil, visualizar imóveis para alugar e vender, adicionar e remover imóveis para que outros vejam, salvar e dessalvar imóveis. A autenticação foi feita com AWS Cognito. Hospedado na AWS Elastic Beanstalk. Atualmente fora do ar para evitar cobranças da AWS. Para mais informações, assista à demonstração no YouTube.',
        image: './assets/home.png',
        technologies: ['Java', 'MySQL', 'Hibernate', 'Maven', 'Bootstrap', 'Log4J', 'AWS Elastic Beanstalk', 'AWS Cognito', 'JUnit'],
        buttons: [
          { text: 'Ver Código Fonte', link: 'https://github.com/eburzlaff/real-estate-app' },
          { text: 'Demo no YouTube', link: 'https://www.youtube.com/watch?v=eT4bvYaDSXw' }
        ],
        id: 1
      },
      {
      ...
      },
      {
        title: 'Team Enterprise Java',
        description:
          'API de backend para gerenciamento de biblioteca pessoal, permitindo rastrear livros, suas localizações e quem os pegou emprestado. Utilizamos a API do Google Books para complementar os dados dos livros.',
        image: './assets/teamEnterprise.png',
        technologies: ['Java', 'MySQL', 'Jackson', 'Google Books API', 'Hibernate', 'Maven', 'Log4J', 'AWS Elastic Beanstalk', 'JUnit', 'SwaggerHub'],
        buttons: [{ text: 'Ver Código Fonte', link: 'https://github.com/eburzlaff/team-enterprise-project' }],
        id: 3
      },
      {
        title: '"Syntax Gym" Prototype',
        description: 'Protótipo simples no Figma para uma academia fictícia.',
        image: './assets/syntaxGym.png',
        technologies: ['Figma'],
        buttons: [
          { text: 'Ver no Figma', link: 'https://www.figma.com/proto/T2VSzdYuXX57hb0cDBKpDS/Project-2---YOUR-PROJECT-GOES-HERE?node-id=63-104&starting-point-node-id=63%3A104&mode=design&t=CEgGoZopXviSV5Yp-1' },
          { text: 'Demo no YouTube', link: 'https://www.youtube.com/watch?v=c_IFxNwTotM' }
        ],
        id: 4
      },
      {
        title: 'CineView Movie App',
        description:
          'Aplicativo de filmes que permite buscar por filmes favoritos e ver informações básicas como título e ano de lançamento.',
        image: './assets/darkMode.png',
        technologies: ['ReactJS', 'Open Movie Database API (OMDb)'],
        buttons: [
          { text: 'Ver Código Fonte', link: 'https://github.com/eburzlaff/cine-view-movie-app' },
          { text: 'Demo ao Vivo', link: 'https://cine-view.netlify.app/' }
        ],
        id: 5
      },
      {
        title: 'To do list App',
        description:
          'Lista de tarefas construída com PHP e MySQL. Usuários podem se registrar, entrar, sair, adicionar, remover e buscar itens da lista.',
        image: './assets/phpTodo.png',
        technologies: ['PHP', 'MySQL'],
        buttons: [{ text: 'Demo no YouTube', link: 'https://www.youtube.com/watch?v=ihZZ7MxV6XU' }],
        id: 6
      },
      {
        title: 'Uncommon Munchies Bakery Website',
        description: 'Site simples de padaria. Criado apenas com HTML e CSS.',
        image: './assets/bakery.png',
        technologies: ['HTML', 'CSS'],
        buttons: [
          { text: 'Ver Código Fonte', link: 'https://github.com/eburzlaff/spring-2020-web-dev-class-final-project' },
          { text: 'Demo ao Vivo', link: 'https://uncommon-munchies-bakery.netlify.app/' }
        ],
        id: 7
      }
